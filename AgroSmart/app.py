...
app.config['MYSQL_PASSWORD'] = 'Ainpur@123'
app.config['MYSQL_DB'] = 'user_login'

mysql = MySQL(app)


model = joblib.load("D:/projrct/AgroSmart/notebooks/fertilizer_app.pkl")


data = pd.read_csv("D:/projrct/AgroSmart/notebooks/fertilizer_recommendation.csv")
...
dtr = pickle.load(open("D:/projrct/AgroSmart/notebooks/dtr.pkl", 'rb'))
preprocessor = pickle.load(open("D:/projrct/AgroSmart/notebooks/preprocesser.pkl", 'rb'))
...
def crop_recommend():
    if request.method == 'POST':
        ...
        try:
            ...
            model = joblib.load("D:/projrct/AgroSmart/notebooks/crop_app.pkl")
            arr = [values]
            ...
            recommended_crops = crop_labels[top_indices]  
...
def yield_predict():
    ...
    df = pd.read_csv("D:/projrct/AgroSmart/notebooks/yield_df.csv")
...
df = pd.read_csv("D:/projrct/AgroSmart/data/analysis1_data.csv")
